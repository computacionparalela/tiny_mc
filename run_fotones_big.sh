...
echo "Ejecutando run_fotones_big.sh"

for cnt_photons in "1048576"  "2097152" "4194304" "8388608" "16777216" "33554432"
do
	make clean
	make ADD_FLAGS="-DPHOTONS=$cnt_photons -DREDUCTION -DTHREADS=8"
